...
const BrowseTips = () => {
  ...
  useEffect(() => {
    fetch('http://localhost:3000/api/garden-tips')  // <-- এখানে :id নাই, সব টিপসের API কল
      .then((res) => {
  ...
  // শুধু public availability এর টিপস দেখাবে
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <h2 className="text-3xl font-bold mb-6 text-center text-green-700">🌿 Public Garden Tips</h2>
        ...
        <div className="overflow-x-auto">
          <table className="table-auto w-full border border-gray-200 shadow-md rounded-lg">
            <thead className="bg-green-100">
              <tr>
                <th className="px-6 py-3 text-left text-sm font-semibold text-gray-700 border-b">Title</th>
                <th className="px-6 py-3 text-left text-sm font-semibold text-gray-700 border-b">Category</th>
                <th className="px-6 py-3 text-left text-sm font-semibold text-gray-700 border-b">Image</th>
            ...
            <tbody>
              {publicTips.map((tip) => (
                <tr key={tip._id} className="bg-white hover:bg-gray-50 transition">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-800 border-b">{tip.category}</td>
