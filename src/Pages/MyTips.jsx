...
const MyTips = ({ user }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 mt-20">
      <h2 className="text-2xl font-bold mb-6 text-center text-green-800 bg-gray-100">
      ...
      {tips.length === 0 ? (
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full border text-sm text-left dark:text-gray-200">
            <thead>
              <tr className="bg-gray-200 border-b dark:border-gray-700 ">
  ...
  {tips.map((tip) => (
    <tr
      key={tip._id}
      className="border-b text-black bg-white border-gray-200 dark:border-gray-700 transition-colors duration-200"
    >
      ...
      {deleteTarget && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 p-6 rounded shadow-xl w-[90%] max-w-md">
            <h3 className="text-xl font-semibold mb-4 text-red-700 dark:text-red-700">
              Confirm Deletion
            </h3>
