...
const Navbar = ({ toggleTheme, theme }) => {
  ...
  return (
    <>
      {/* Navbar */}
      <nav className="fixed top-0 left-0 w-full bg-white dark:bg-gray-900 shadow-md z-[9999] h-16 flex items-center px-4 justify-between">
        {/* Left: Hamburger + Logo */}
      ...
      {/* Desktop Menu */}
      <ul className="hidden lg:flex space-x-6 items-center mt-16 px-6">
        <li>
