...
const TrendTip = () => {
  ...
  return (
    <div className="p-4 max-w-7xl mx-auto mt-20">
      <h2 className="text-2xl font-bold mb-4 text-green-500">Top Trending Tips</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {tips.map(tip => (
          <div key={tip.id} className="border rounded-lg shadow p-4  dark:bg-gray-800">
            <h3 className="text-lg font-semibold">{tip.title}</h3>
            <p className=" dark:text-white">{tip.description}</p>
